!offset = $40 ;moving everything down one tileoffsetInput
!offsetXCoord = $02+!offset
!offsetInput = $18+!offset
!offsetClipInfo = $CA+!offset
...
str_early:		; "PRESSED A: 0 F EARLY"	 40 frames, ldx #$28
...
str_late:		; "0 F LATE"   16 bytes, ldx #$10
...
-	LDA str_early,X
	...
	LDX #$10
-	LDA str_late,X
	STA !RAM_BAR+!offsetClipInfo+$56,X
	DEX
	DEX
	BPL -
	;numbers
